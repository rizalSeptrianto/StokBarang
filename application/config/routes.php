...
//route data retur barang

$route['data_retur'] = 'retur/index';
$route['tambah_retur'] = 'retur/tambah_retur';
$route['hapus_retur'] = 'retur/hapus_retur';
$route['data_retur/(:any)'] = 'retur/detail_retur/$1';
$route['edit_retur'] = 'retur/edit_retur';
$route['edit_retur/(:any)'] = 'retur/edit_retur/$1';
$route['tambah_cart_retur'] = 'retur/tambah_cart_retur';
$route['get_item'] = 'retur/get_item';
$route['update_cart_retur'] = 'retur/update_cart_retur';
$route['remove_item'] = 'retur/remove_item';
$route['ajax_retur'] = 'retur/ajax_retur';
