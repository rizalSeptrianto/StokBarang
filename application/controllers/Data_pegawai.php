        ...
        if ($this->input->is_ajax_request()) {
            ...
            foreach ($list as $i) {
                ...
                $row[] = '<div  class="d-flex justify-content-end">
                  <a href="' . site_url('pegawai/' . $i->username) . '" class="btn btn-success btn-sm mr-2">Detail</a>
                  <a href="' . site_url('edit_pegawai/' . $i->username) . '" class="btn btn-warning btn-sm mr-2 text-white">Edit</a>
