...
<nav id="sidebar" style="background-color: #468585;" >
    <div class="p-4 pt-5">
        <a href="<?= site_url(); ?>" class="img logo rounded-circle mb-3" style="background-image: url(<?= base_url('assets/img/login.png'); ?>);"></a>
