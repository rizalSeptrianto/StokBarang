...
<div class="row">
    <div class="col-sm-12 col-md-10">
        <h4 class="mb-0"><i class="fa fa-share"></i> Detail Retur Barang</h4>
    </div>
</div>
<hr class="mt-0" />
<h6 class="mb-2">ID Retur</h6>
<p class="text-muted display-5 mt-1 mb-2">#<?= $d->id_retur; ?> ( <?= tanggal_indo($d->tgl_retur); ?> )</p>
...
<table class="table table-sm table-hover">
    ...
    <tbody>
        ...
        <?php endforeach; ?>
        <tr>
            <td colspan="6" class="text-center"><b>Biaya Total retur</b></td>
            <td>
                <b>
                    <span class="float-left">Rp.</span>
                    <span class="float-right pr-3">
