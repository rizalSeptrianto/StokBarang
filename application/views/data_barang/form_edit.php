    ...
    <div class="card-body">
        ...
        <div class="col-md-8">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <input type="Number" class="form-control form-control-sm <?= (form_error('stok')) ? 'is-invalid' : ''; ?>" id="stok" name="stok" placeholder="Stok Barang" value="<?= (set_value('stok')) ? set_value('stok') : $barang->stok; ?>">
                    <div class="invalid-feedback">
