<div class="card shadow">
    ...
    <?= form_open('tambah_penjualan/tambah_cart'); ?>
    <div class="col-md-12">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <select class="barang-select custom-select custom-select-sm pilih-barang" name="barang" id="barang-penjualan">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-2">
                <input type="text" name="jumlah" class="form-control form-control-sm qty" id="jumlahx" placeholder="Jumlah Beli">
            </div>
        </div>
        <div class="form-group row">
